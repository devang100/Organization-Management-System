...
table{
 ...
 font-style: normal;
 font-weight: bold;
 background: linear-gradient(to bottom, #fafafa 0%, #b26ef1 100%);  
...
<tr>
<td>First Name</td>
<td><input type="text" name="FirstName" maxlength="50" placeholder="Devang" />
</td>
</tr>
<!------------------------ Last Name --------------------------------------->
<tr>
<td>Last Name</td>
<td><input type="text" name="LastName" maxlength="50" placeholder="Patel"/>
</td>
</tr>
<!-------------------------- Email ID ------------------------------------->
<tr>
<td>Email ID</td>
<td><input type="email" name="EmailID" maxlength="100" placeholder="@gmail.com"/></td>
</tr>
<!-------------------------- Mobile Number ------------------------------------->
<tr>
<td>Mobile Number</td>
...
<tr>
<td>City</td>
<td><input type="text" name="City" maxlength="50" placeholder="Vadodara"/>
...
<tr>
<td>Pin Code</td>
<td><input type="Number" name="PinCode" maxlength="6" placeholder="xxxxxx"/>
...
<tr>
<td>State</td>
<td><input type="text" name="State" maxlength="50" placeholder="karelibaug"/>
